...
public class SharedGoal extends ParseObject {
    ...
    public SharedGoal(String title, String description, int duration, int frequency, int progress, int streak, ArrayList<ParseObject> story, ParseUser user, Boolean itemAdded, Date updateBy, List<ParseUser> pending, List<ParseUser> approved) {
        super();
        setTitle(title);
    ...
    public static class Query extends ParseQuery<SharedGoal> {
        public Query() {
            super(SharedGoal.class);
        }

        public SharedGoal.Query getTop() {
            orderByDescending("createdAt");
            return this;
        }

        public SharedGoal.Query withImages(){
            include("images");
            return this;
        }
    }
